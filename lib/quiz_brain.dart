...
class QuizBrain {
  ...
  String getQuestionText() {
    return _lstQuestions[_questionNumber].questionText;
  }

  bool getQuestionAnswer() {
    return _lstQuestions[_questionNumber].questionAnswer;
  }

  void nextQuestion() {
    if (_questionNumber <= _lstQuestions.length - 1) {
      _questionNumber++;
    }
  }

  bool isFinished() {
    return _questionNumber == _lstQuestions.length - 1;
  }
  ...
  void setCorrectAnswerCount() {
    _correctAnswerCount++;
  }

  int getTotalQuestionsCount() {
    return _lstQuestions.length;
  }
}
